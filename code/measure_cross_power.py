...
if __name__=="__main__":
	...
	for model_id in cmd_args.id:
		...
		if cosmo_id==batch.fiducial_cosmo_id:
			driver.main(batch,cosmo_id,int(n),"cross_spectra.sqlite","features_fiducial",measurer=cross_power,pool=None,ell_edges=ell_edges,indices=indices)
		else:
			driver.main(batch,cosmo_id,int(n),"cross_spectra.sqlite","features",measurer=cross_power,pool=None,ell_edges=ell_edges,indices=indices)